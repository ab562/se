...
<%--jQuery Cookie操作插件--%>
<script src="${pageContext.request.contextPath}/resource/jquery.cookie.min.js"></script>
<%--jQuery countDown倒计时插件--%>
<script src="${pageContext.request.contextPath}/resource/jquery.countdown.min.js"></script>
